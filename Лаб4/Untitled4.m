...
P=0.411053*10^5; % статическое давление

T=242.7; % температура в Кельвинах

R=287.053; % газовая постоянная воздуха

ro=0.590018; % плотность

a_inf=312.306; % скорость звука в невозмущённом набегающем потоке
